    ...
    public void initSDK_Sample(Application context) {
        ...
        if(type==TcmsEnvType.ONLINE || type == TcmsEnvType.PRE){
            if(TextUtils.isEmpty(appkey)) {
                YWAPI.init(mApp, ConstantsUtil.APP_KEY);
            } else {
                    ...
                    if (messageBody.getTransparentFlag() == 1) {
                        ...
                        try {
                            ...
                            if (object.has("text")){
                                ...
                                Notification.showToastMsgLong(mApp, "透传消息，content = " + text);
...
//    public void loginOut_Sample(final Context context) {
//    	mIMKit = MyApplication.getInstance().getmIMKit();
//        if (mIMKit == null) {
//        	LoginSampleHelper.getInstance().setAutoLoginState(YWLoginState.idle);
//        	Utils.StartLogin((Activity) context,true);
//            return;
//        }
//
//        // openIM SDK提供的登录服务
