...
public class UserDefineScrollView extends ScrollView {
	...
	private void boundBack() {
		...
		if(mListener !=null){
			mListener.scrollOritention(canPullUp);
		}
//		if(mListener !=null){
//			mListener.scrollTopOritention(canPullDown);
//		}
...
//		public void scrollTopOritention(boolean isTop);  
	}
	private OnLoadMore mListener ;
	public void setScrollListener(OnLoadMore l) {  
        this.mListener = l;  
    } 
}
