...
public class TabView extends View {
	...
	private static final String TAG = TabView.class.getName();
	...
	public TabView(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
			...
			switch (attr) {
			case R.styleable.TabViewStyle_drawable:
				BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
				mIconBitmap = drawable.getBitmap();
				break;
			case R.styleable.TabViewStyle_textColor:
				mColor = a.getColor(attr, 0x45C01A);
				break;
			case R.styleable.TabViewStyle_text:
				mText = a.getString(attr);
				break;
			case R.styleable.TabViewStyle_textSize:
	...
	private void setupTargetBitmap(int alpha) {
		...
		mPaint = new Paint();
		// mPaint.setColor(getResources().getColor(R.));
		mPaint.setColor(getResources().getColor(R.color.color_666666));
		// mPaint.setColor(getResources().getColor(R.color.sf_gray_bb));
