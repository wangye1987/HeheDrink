...
//					StartActivityUtil.startActivity(GuideActivity.this, intentLeft);
//				}
//			}
//		}
	}
...
//		btStart.setOnClickListener(this);
	...
	private void initData() {
		...
		try {
			spName = sharedPreferences_create.getString(initTag+ "_"+ getPackageManager().getPackageInfo(getPackageName(), 0).versionCode, isFirst);
		...
		if (spName.equals(isFirst)) {
			...
			ApiHttpCilent.getInstance(getApplicationContext()).login(this,
...
//		MoreUserInfo();
		...
		ApiHttpCilent.getInstance(getApplicationContext()).BindCid(GuideActivity.this, loginBean.getResult().getId(), cid, new MyCidCallBack());
