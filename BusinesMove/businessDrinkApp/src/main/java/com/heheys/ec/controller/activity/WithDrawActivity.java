...
//		if(ValidatorUtil.isMobile(tellength)){
			startCountDown();
			ApiHttpCilent.getInstance(getApplicationContext()).ObtinCode(baseActivity, tellength, new MyCallBack(),ConstantsUtil.CODE_FLAG_6);//获取验证码
//		}
	}
...
//	}
	...
	public void onClick(View v) {
		...
		case R.id.bt_getmoney:
			...
			if(isTextEmpty()){
			ApiHttpCilent.getInstance(getApplicationContext()).setDefaultCard(baseContext, yinhang_name_text,
