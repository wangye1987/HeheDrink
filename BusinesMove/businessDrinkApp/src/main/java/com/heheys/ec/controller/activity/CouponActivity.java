...
//					"message", "new", false);
		...
		if("use".equals(key)){
			...
			ApiHttpCilent.getInstance(getApplicationContext()).CouponCanuser(this, baseamount,new MyUserCouponCallBack());
		}else{
			ApiHttpCilent.getInstance(getApplicationContext()).CouponMy(this,new MyCouponCallBack());
		}
	}
