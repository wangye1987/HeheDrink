/*
package com.heheys.ec.thirdPartyModule.IM;
...
/**
    ...
    public int getMsgBackgroundResId(YWConversation conversation, YWMessage message, boolean self) {
        ...
        if (msgType == YWMessage.SUB_MSG_TYPE.IM_TEXT || msgType == YWMessage.SUB_MSG_TYPE.IM_AUDIO){
            if (self){
                return R.drawable.myim;
            } else {
                return R.drawable.youim;
            }
...
/**
    ...
    @Override
    public boolean needHideTitleView(android.support.v4.app.Fragment fragment,
...
/**
    ...
    @Override
    public View getCustomTitleView(final android.support.v4.app.Fragment fragment,
        ...
        view.setBackgroundColor(Color.parseColor("#af2942"));
        ...
        if (conversation.getConversationType() == YWConversationType.P2P) {
            ...
            if (!TextUtils.isEmpty(conversationBody.getContact().getShowName())) {
                ...
                YWIMKit imKit = null;
//                YWIMKit imKit = MyApplication.getInstance().getmIMKit();
...
/**
    ...
    @Override
    public boolean onImagePreviewTitleButtonClick(android.support.v4.app.Fragment fragment, YWMessage message) {
...
/**
    ...
    @Override
    public String getImageSavePath(android.support.v4.app.Fragment fragment, YWMessage message) {
//        return Environment
...
/**
    ...
    @Override
    public View getChattingFragmentCustomViewAdvice(android.support.v4.app.Fragment fragment, Intent intent) {
...
/**
    ...
    @Override
    public boolean isUseChattingCustomViewAdvice(android.support.v4.app.Fragment fragment, Intent intent) {
        if (intent != null && intent.hasExtra("extraTribeId") && intent.hasExtra("conversationType")) {
...
//        MyApplication.getInstance().getmIMKit().getIMCore().getTribeService().unblockTribe(tribe, new IWxCallback() {
//            @Override
...
/**
    ...
    public int getExpandViewUnCheckedBgResId() {
        return R.drawable.bt_bg_yellow;
    }
...
/**
	...
	public int getDefaultRoomHeadImageResId() {
		// TODO Auto-generated method stub
		return super.getDefaultRoomHeadImageResId();
	}

	@Override
	public int getDefaultTribeHeadImageResId() {
		// TODO Auto-generated method stub
		return super.getDefaultTribeHeadImageResId();
	}

	@Override
	public void onSetAudioContentImage(ImageView view, int index, int direction) {
		// TODO Auto-generated method stub
		super.onSetAudioContentImage(view, index, direction);
	}

	@Override
	public void onCustomDrawRecordButton(Canvas canvas, RecordButton button) {
		// TODO Auto-generated method stub
//		super.onCustomDrawRecordButton(canvas, button);
		button.setBackgroundResource(R.drawable.salon_apply_full);
	}
